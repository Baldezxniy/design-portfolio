...
export default function Header() {
    ...
    return (
        <header className={'z-[999] relative'}>
            <motion.div
                className='fixed top-0 left-1/2 h-[4.6rem] w-full rounded-none border border-white border-opacity-40
            ...
            <nav
                className={'fixed flex top-[0.15rem] left-1/2 -translate-x-1/2 h-12 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'}>
